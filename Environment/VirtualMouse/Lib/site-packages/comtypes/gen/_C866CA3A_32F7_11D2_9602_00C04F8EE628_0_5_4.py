...
__all__ = [
    'DISPID_SOTsItem', 'eLEXTYPE_PRIVATE20',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRSTsItem',
    'DISPID_SpeechObjectTokens', 'SDTPronunciation',
    'SpeechRetainedAudioOptions', 'ISpeechGrammarRule',
    'STSF_CommonAppData', 'SAFT32kHz8BitMono', 'DISPID_SVEStreamEnd',
    'SP_VISEME_3', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSTText',
    'SREAllEvents', 'DISPID_SRGRecoContext', 'SREPrivate',
    'SPSModifier', 'DISPID_SOTIsUISupported', 'SECFNoSpecialChars',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechLexiconWord',
    'DISPID_SVEPhoneme', 'SVP_0', 'DISPID_SRCRetainedAudio',
    'DISPID_SPIGetDisplayAttributes', 'ISpPhoneticAlphabetConverter',
    'DISPID_SFSClose', 'DISPID_SOTSetId', 'ISpRecoContext2',
    'ISpeechPhraseAlternate', 'SpeechEngineConfidence',
    'SAFT16kHz8BitStereo', 'DISPID_SRCEAudioLevel', 'SGDSActive',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTADPCM_11kHzMono',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEPhraseStart',
    'DISPID_SMSGetData', 'DISPIDSPTSI', 'DISPID_SPRDisplayAttributes',
    ...
    'DISPID_SPAs_NewEnum', 'SpeechLexiconType', 'SAFTADPCM_22kHzMono',
    'DISPID_SOTGetDescription', 'SPPHRASEREPLACEMENT',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SOTDataKey',
    'SpeechCategoryAudioOut', 'ISpPhraseAlt',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT32kHz8BitStereo',
    'SAFT48kHz16BitMono', 'DISPID_SGRAddResource',
    'SAFT16kHz16BitStereo', 'SPRECOGNIZERSTATUS', 'SRAORetainAudio',
    'SVEVoiceChange', 'SpeechMicTraining', 'SRATopLevel',
    ...
    'DISPID_SVEWord', 'DISPID_SVEVoiceChange', 'DISPID_SPPsItem',
    'SPAUDIOSTATE', 'DISPID_SBSSeek', 'SP_VISEME_7', 'SVPNormal',
    'SpeechRuleState', 'DISPID_SWFEChannels', 'SAFTADPCM_44kHzMono',
    'DISPID_SPEAudioTimeOffset', 'Speech_Max_Word_Length',
    'ISpeechLexiconWord', 'SPPS_Interjection', 'DISPID_SVVoice',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SREPropertyStringChange',
    'DISPID_SVEStreamStart', 'DISPID_SPRsCount',
    'DISPID_SRCreateRecoContext', 'UINT_PTR', 'SVP_5',
    'SAFT16kHz16BitMono', 'DISPID_SGRsCommitAndSave',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGId', 'SPAS_CLOSED',
    'SpeechPropertyHighConfidenceThreshold', 'SPEVENT',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SOTsCount',
    'DISPID_SRCCmdMaxAlternates', 'SVSFDefault', 'SVP_12',
    'SWPUnknownWordPronounceable',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRsDynamic',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVEViseme',
    'DISPID_SGRsCommit', 'SPINTERFERENCE_NOISE', 'SPPS_RESERVED4',
    'DISPID_SBSWrite', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechPhraseElements',
    'SpResourceManager', 'SPWF_INPUT', 'SVSFUnusedFlags',
    'DISPID_SpeechPhraseProperties',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechCustomStream',
    'SpeechGrammarState', 'SPADAPTATIONRELEVANCE', 'SRTStandard',
    'SpMMAudioOut', 'SVP_4', 'ISpeechPhoneConverter', 'SPAR_Low',
    'SPVPRI_ALERT', 'DISPID_SPAStartElementInResult',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPIProperties', 'SINoSignal',
    'ISpeechXMLRecoResult', 'DISPID_SFSOpen', 'SAFT12kHz16BitStereo',
    'ISpeechPhraseInfoBuilder', 'eLEXTYPE_PRIVATE2',
    'SPRECOCONTEXTSTATUS', 'SPSTREAMFORMATTYPE', 'SPSHT_EMAIL',
    'ISpGrammarBuilder', 'DISPID_SVSVisemeId', 'SAFT11kHz16BitMono',
    'ISpRecoContext', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRGetFormat', 'eLEXTYPE_PRIVATE18', 'SPBINARYGRAMMAR',
    'SASClosed', 'DISPID_SPRsItem', 'SRAInterpreter', 'SVSFNLPMask',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPRs_NewEnum',
    'ISpRecoGrammar', 'ISpProperties', 'SPEI_TTS_BOOKMARK',
    'SITooSlow', 'SAFT22kHz16BitMono', 'DISPID_SRAudioInput',
    'SPXRO_Alternates_SML', 'SPLEXICONTYPE', 'SVP_9',
    'DISPID_SDKGetlongValue', 'DISPID_SOTs_NewEnum',
    'SPFM_OPEN_READONLY', 'SVEAllEvents', 'SREHypothesis',
    'SpeechAddRemoveWord', '_SPAUDIOSTATE', 'SPPS_SuppressWord',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechPhraseRule', 'DISPID_SAFType',
    'SRSEIsSpeaking', 'ISpeechLexiconWords', 'ISpShortcut',
    'ISpRecognizer2', 'DISPID_SpeechXMLRecoResult', 'SPCONTEXTSTATE',
    'DISPID_SpeechDataKey', 'SAFT8kHz16BitStereo',
    'DISPID_SGRSTWeight', 'SPWORDPRONOUNCEABLE', 'SPGRAMMARWORDTYPE',
    'SAFTNoAssignedFormat', 'SPEI_TTS_AUDIO_LEVEL',
    'eWORDTYPE_DELETED', 'SpeechEmulationCompareFlags',
    'SPPHRASERULE', 'SVP_18', 'SPWF_SRENGINE', 'SPPS_RESERVED2',
    'DISPID_SVSInputSentencePosition', 'SRSInactive', 'SRERequestUI',
    'DISPID_SRCEEnginePrivate', 'SREStreamStart',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVResume',
    'DISPID_SAEventHandle', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SLWType', 'SECFDefault', 'ISpeechFileStream',
    'DISPID_SLRemovePronunciation', 'DISPID_SASetState',
    'DISPID_SVAlertBoundary', 'SAFT24kHz8BitStereo', 'SPCS_DISABLED',
    'SPFM_OPEN_READWRITE', 'SPAS_RUN', 'eLEXTYPE_PRIVATE3',
    'SREPropertyNumChange', 'SSTTDictation', 'SPEI_SOUND_START',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCResume',
    'SVESentenceBoundary', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SVEAudioLevel', 'DISPID_SLPPartOfSpeech',
    'DISPID_SGRName', 'SPSERIALIZEDPHRASE', 'SRCS_Disabled', 'SLTApp',
    'SpeechAllElements', 'DISPID_SDKSetLongValue',
    'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_18', 'SPLO_STATIC',
    'DISPID_SPARecoResult', 'DISPID_SRCEFalseRecognition',
    'SpeechTokenKeyUI', 'SDTLexicalForm',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRIsUISupported',
    'SpeechStreamFileMode', 'DISPID_SPPId', 'DISPID_SAVolume',
    ...
    'ISpeechRecognizer', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGCmdLoadFromMemory', 'SPXMLRESULTOPTIONS',
    'SPVPRI_NORMAL', 'SPSMF_UPS', 'DISPID_SPEDisplayText',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVESentenceBoundary', 'SPEI_MAX_SR',
    'DISPID_SREmulateRecognition', 'SPBO_TIME_UNITS', 'SITooLoud',
    'DISPIDSPTSI_SelectionOffset', 'SPRULE', 'DISPID_SCSBaseStream',
    'SPCS_ENABLED', 'DISPID_SVSLastResult', 'SpeechDiscardType',
    'SITooFast', 'ISpeechMMSysAudio', 'SWPKnownWordPronounceable',
    'SpeechRuleAttributes', 'SRSActive',
    'DISPID_SRSCurrentStreamNumber', 'SpeechAudioFormatType',
    'SPWT_DISPLAY', 'DISPID_SVSpeak', 'DISPID_SBSRead', 'SP_VISEME_1',
    'SpMMAudioEnum', 'DISPID_SPISaveToMemory',
    'DISPID_SVAudioOutputStream', 'SpeechVoicePriority',
    'SpeechRecoEvents', 'SpeechVoiceSpeakFlags',
    'SpeechCategoryAudioIn', 'ISpVoice', 'SAFT11kHz8BitStereo',
    'DISPID_SWFESamplesPerSec', 'SVP_13', 'SPINTERFERENCE_NONE',
    'SpLexicon', 'SpeechTokenKeyFiles', 'SGSExclusive',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SGRSTTDictation',
    'SVEEndInputStream', 'eLEXTYPE_PRIVATE16',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPVPRI_OVER',
    'DISPID_SpeechPhraseBuilder', 'SVSFPersistXML',
    'SpPhoneConverter', 'SAFT12kHz8BitMono', 'SP_VISEME_19',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPERequiredConfidence', 'SVP_8', 'SPWORD', 'DISPID_SOTId',
    'Speech_StreamPos_Asap', 'ISpeechRecoResult2',
    'ISpeechPhraseRules', 'eLEXTYPE_VENDORLEXICON', 'SPRST_INACTIVE',
    'SPPS_Function', 'SPEI_ADAPTATION', 'DISPID_SPEs_NewEnum',
    'DISPID_SPPsCount', 'DISPID_SpeechMMSysAudio', 'SPEI_MAX_TTS',
    'SVF_Stressed', 'SVF_Emphasis', 'SPWT_LEXICAL', 'SP_VISEME_8',
    'ISpObjectWithToken', 'DISPID_SVSkip',
    '_ISpeechRecoContextEvents', 'ISpeechRecoGrammar',
    'ISpeechPhraseAlternates', 'SAFTText', 'DISPID_SPRFirstElement',
    'ISpeechBaseStream', 'SECHighConfidence', 'SVP_15',
    'eLEXTYPE_RESERVED6', 'SPDKL_CurrentConfig', 'ISpeechPhraseRule',
    'eLEXTYPE_RESERVED7', 'SpeechTokenValueCLSID',
    'DISPID_SVSPhonemeId', 'SAFTCCITT_uLaw_8kHzStereo', 'SDTAll',
    'SPEI_WORD_BOUNDARY', 'STCRemoteServer', 'ISpRecoCategory',
    'SpeechAudioProperties', 'SPWORDLIST', 'SREAdaptation',
    'Speech_Max_Pron_Length', 'DISPID_SRStatus',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPCT_DICTATION',
    'ISpXMLRecoResult', 'SpFileStream', 'SP_VISEME_20',
    'SpeechLoadOption', 'DISPID_SGRSTsCount', 'SPSEMANTICERRORINFO',
    'SPEI_PHRASE_START', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE15', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT32kHz16BitStereo', 'ISpeechRecognizerStatus', 'SVP_19',
    'DISPID_SPIAudioSizeTime', 'SPPROPERTYINFO', 'SITooQuiet',
    'SPBO_PAUSE', 'SP_VISEME_14', 'ISpStream', 'SDTAudio',
    'SRERecognition', 'SAFT44kHz16BitMono', 'ISpRecognizer',
    'SBONone', 'eLEXTYPE_PRIVATE5', 'SREInterference',
    'SPWT_PRONUNCIATION', 'DISPID_SRCEBookmark', 'SRARoot',
    'SPBO_NONE', 'DISPID_SGRAttributes', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPIRule', 'DISPID_SLGetGenerationChange',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPIEnginePrivateData',
    'DISPID_SGRs_NewEnum', 'SpCustomStream',
    'DISPID_SpeechVoiceEvent', 'SPSEMANTICFORMAT', 'SP_VISEME_12',
    ...
    'DISPID_SDKDeleteKey', 'SVP_1', 'SP_VISEME_21',
    'SGDSActiveWithAutoPause', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCBookmark', 'ISpeechLexiconPronunciations', 'SPXRO_SML',
    'DISPID_SOTCEnumerateTokens', 'SDTDisplayText',
    'SPRST_NUM_STATES', 'SPSHT_NotOverriden', 'ISpEventSink',
    'SPPS_NotOverriden', 'SpWaveFormatEx', 'SPPHRASEPROPERTY',
    'SpeechRegistryUserRoot', 'SAFTCCITT_uLaw_11kHzMono', 'SPPS_Noun',
    'SpAudioFormat', 'SPDKL_DefaultLocation', 'SPEI_MIN_SR',
    'DISPID_SRRTTickCount', 'SASStop', 'SPEI_UNDEFINED',
    'SRERecoOtherContext', 'DISPID_SMSSetData',
    'SpeechGrammarTagUnlimitedDictation',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechBookmarkOptions',
    'DISPID_SRCEPropertyNumberChange', 'SVEViseme', 'SDTAlternates',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SASNonBlockingIO',
    'SPRECORESULTTIMES', 'SECFIgnoreCase',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_17',
    'SpeechGrammarTagWildcard', 'SPRS_ACTIVE',
    'DISPID_SpeechLexiconWords', 'SPPHRASEELEMENT', 'eLEXTYPE_APP',
    'DISPID_SRRAudioFormat', 'SVP_3', 'SP_VISEME_11',
    'DISPID_SPRuleConfidence', 'SpeechTokenKeyAttributes',
    'SPDATAKEYLOCATION', 'DISPID_SVGetAudioInputs', 'SDTRule',
    'DISPID_SMSAMMHandle', 'SPBO_AHEAD', 'SPAS_PAUSE',
    'SVSFParseSapi', 'SASPause', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRDisplayUI', 'SVP_20', 'DISPID_SRState',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPEAudioSizeBytes',
    'SPWAVEFORMATTYPE', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRsFindRule',
    'ISpeechRecoResultDispatch', 'SPGRAMMARSTATE',
    'SpObjectTokenCategory', 'SPWORDPRONUNCIATION',
    'DISPID_SRAudioInputStream', 'SpeechEngineProperties', 'SINoise',
    'DISPID_SpeechGrammarRuleState', 'SRESoundStart',
    'DISPID_SpeechRecoContext', 'ISpStreamFormatConverter',
    'DISPID_SPEActualConfidence', 'DISPID_SPCIdToPhone',
    'DISPID_SGRSTPropertyName', 'SpeechPartOfSpeech',
    'ISpeechWaveFormatEx', 'SP_VISEME_5',
    'DISPID_SRSSupportedLanguages', 'SREBookmark', 'DISPID_SLWLangId',
    'DISPID_SRRSaveToMemory', 'SpeechGrammarWordType',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTRemoveStorageFileName',
    'STSF_LocalAppData', 'DISPID_SLPType', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechRecoResult2', 'ISpeechLexicon', 'SAFT8kHz16BitMono',
    'SPSHORTCUTPAIR', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCEventInterests',
    'DISPID_SRCRequestedUIType', 'STCAll', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SBSFormat', 'DISPID_SGRSAddWordTransition',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_RESERVED8',
    'SAFT44kHz8BitMono', 'SVPOver', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRSTRule',
    'ISpeechGrammarRuleState', 'SPSUnknown', 'SAFT24kHz16BitMono',
    'SECLowConfidence', 'DISPID_SRGDictationSetState',
    'ISpNotifyTranslator', 'DISPID_SRSAudioStatus',
    'DISPID_SPIGrammarId', 'SGRSTTRule', 'SPEI_SR_PRIVATE',
    'DISPID_SDKSetStringValue', 'DISPID_SLPPhoneIds',
    'SpSharedRecoContext', 'DISPID_SMSADeviceId', 'tagSTATSTG',
    'DISPID_SpeechPhraseAlternates', 'SVF_None', '_RemotableHandle',
    'DISPID_SAFGuid', 'eLEXTYPE_PRIVATE9', 'SPEI_HYPOTHESIS',
    'eLEXTYPE_PRIVATE19', 'SpeechCategoryAppLexicons', 'ISpPhrase',
    'DISPID_SPEDisplayAttributes', 'SPVPRIORITY', 'SVP_6',
    'DISPID_SGRsItem', 'DISPID_SVEBookmark', 'SREPhraseStart',
    'DISPID_SRGIsPronounceable', 'SDA_One_Trailing_Space', 'ISpAudio',
    'SPEI_VISEME', 'DISPID_SOTCGetDataKey', 'DISPID_SRRPhraseInfo',
    'SGDSActiveUserDelimited', 'DISPID_SLPsCount', 'SPEI_RESERVED6',
    'DISPID_SPPs_NewEnum', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPPFirstElement', 'SPPS_LMA', 'SSTTTextBuffer', 'SVP_10',
    'ISpRecoResult', 'SPEI_REQUEST_UI', 'SVSFParseMask', 'SpStream',
    'SSSPTRelativeToStart', 'DISPID_SADefaultFormat',
    'DISPID_SRGetRecognizers', 'SPEVENTENUM', 'DISPID_SLWsCount',
    'DISPID_SDKGetStringValue', 'DISPID_SRGRules', 'SDKLLocalMachine',
    'SPEI_RESERVED5', 'SP_VISEME_0', 'DISPID_SRGDictationLoad',
    'SPSVerb', 'SAFT22kHz8BitMono', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechPropertyAdaptationOn',
    'DISPID_SMSALineId', 'SSFMOpenReadWrite', 'SRADynamic',
    'DISPID_SGRSTPropertyId', 'SpeechUserTraining',
    'DISPID_SRRGetXMLErrorInfo', 'STSF_FlagCreate', 'SP_VISEME_9',
    'SVSFIsXML', 'SAFTCCITT_ALaw_22kHzStereo', 'SGDSInactive',
    'ISpeechPhraseElement', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRRGetXMLResult', 'STCInprocServer', 'ISpeechVoice',
    'ISpeechObjectTokens', 'SVSFlagsAsync', 'SPPS_Verb',
    'DISPID_SOTCId', 'DISPID_SRCVoicePurgeEvent',
    'SpeechRecoContextState', 'DISPID_SDKCreateKey', 'SLOStatic',
    'DISPID_SASState', 'SpeechAudioVolume', 'SpShortcut',
    'SpeechAudioState', 'DISPID_SLGetWords', 'SAFTDefault',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SOTGetAttribute',
    'DISPID_SRGSetTextSelection', 'DISPID_SRRAlternates',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRTStreamTime',
    'DISPID_SVEventInterests', 'SP_VISEME_6', 'ISpSerializeState',
    'DISPID_SLWsItem', 'SVP_7', 'DISPID_SOTGetStorageFileName',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE7', 'SPSHORTCUTPAIRLIST',
    'SPCATEGORYTYPE', 'DISPID_SpeechRecognizerStatus',
    'SpNotifyTranslator', 'SSTTWildcard', 'SPSHT_OTHER',
    'DISPID_SPEPronunciation', 'ISpeechAudioStatus',
    'DISPID_SPPConfidence', 'DISPID_SASCurrentDevicePosition',
    'SPINTERFERENCE', 'DISPID_SGRAddState', 'SRTExtendableParse',
    'DISPID_SpeechObjectTokenCategory', 'SPFM_CREATE',
    'DISPID_SRSetPropertyString', 'SAFT16kHz8BitMono',
    'DISPID_SPIAudioSizeBytes', 'SLTUser', 'DISPID_SPCLangId',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRIsShared',
    'DISPID_SGRSRule', 'DISPID_SRCEInterference',
    'DISPID_SLGenerationId', 'DISPID_SRGCmdSetRuleState',
    'SGRSTTEpsilon', 'SpeechTokenContext', 'DISPID_SpeechAudioFormat',
    'DISPID_SABIBufferSize', 'DISPID_SVAudioOutput', 'IEnumString',
    'SpInprocRecognizer', 'SPSERIALIZEDRESULT', 'DISPID_SPIElements',
    'ISpObjectTokenCategory', 'ISpeechPhraseInfo',
    'eLEXTYPE_PRIVATE13', 'SPAR_Medium', 'SPFM_NUM_MODES',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVSLastBookmarkId',
    'SAFT24kHz16BitStereo', 'DISPID_SVSInputWordPosition',
    'DISPID_SPRulesCount', 'SpTextSelectionInformation',
    'SPEVENTSOURCEINFO', 'SVSFParseAutodetect', 'SPSLMA',
    'DISPID_SPELexicalForm', 'ISpeechRecoResult', 'DISPID_SGRsCount',
    'DISPID_SGRSAddRuleTransition', 'ISpeechPhraseReplacement',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRules_NewEnum',
    'SAFT22kHz16BitStereo', 'SpStreamFormatConverter',
    'DISPID_SPILanguageId', 'DISPID_SpeechPhraseRules',
    'DISPID_SLWPronunciations', 'ISpeechObjectToken', 'SRAExport',
    'DISPID_SVSRunningState', 'SAFTADPCM_8kHzStereo',
    'SpeechWordPronounceable', 'SpeechRecognitionType',
    'DISPID_SGRId', 'SRTAutopause', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_PRIVATE4', 'STCLocalServer', 'SPAR_Unknown',
    'DISPID_SRCCreateResultFromMemory', 'ISequentialStream',
    'SAFT12kHz16BitMono', 'DISPID_SDKGetBinaryValue', 'SPVISEMES',
    'SRAImport', 'DISPID_SPRuleId', 'SAFT11kHz16BitStereo',
    'DISPID_SOTMatchesAttributes', 'SAFTExtendedAudioFormat',
    'DISPID_SVSLastStreamNumberQueued', 'ISpResourceManager',
    'SpeechDataKeyLocation', 'SLODynamic', 'DISPID_SRCPause',
    ...
    'ISpeechGrammarRuleStateTransition', 'SPEI_INTERFERENCE',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRulesItem',
    'DISPID_SVSLastBookmark', 'SPFILEMODE', 'SPPS_Modifier',
    'DISPID_SRCESoundStart', 'STSF_AppData', 'SAFT44kHz8BitStereo',
    'ISpeechPhraseReplacements', 'eLEXTYPE_RESERVED10',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SFTInput',
    'DISPID_SpeechPhraseInfo', 'SPRULESTATE',
    'DISPID_SpeechFileStream', 'SGSEnabled', 'SGSDisabled',
    'SREFalseRecognition', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_SENTENCE_BOUNDARY', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRGCmdLoadFromObject', '_ISpeechVoiceEvents',
    'DISPID_SRCEEndStream', 'DISPID_SRCESoundEnd',
    'SRSInactiveWithPurge', 'SSFMOpenForRead', 'DISPID_SOTCDefault',
    'SVP_11', 'ISpeechPhraseProperty', 'DISPID_SVPriority',
    'DISPID_SpeechAudio', 'ISpeechAudio', 'LONG_PTR', 'SPPS_Unknown',
    'SBOPause', 'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPSHORTCUTTYPE', 'SPAR_High', 'SDKLCurrentUser',
    'ISpeechRecoResultTimes', 'SpeechStreamSeekPositionType',
    'SPRST_ACTIVE_ALWAYS', 'SECFIgnoreKanaType', 'DISPID_SRCState',
    'SRSActiveAlways', 'DISPID_SRRTimes',
    'SpeechPropertyResponseSpeed', 'SPEI_END_SR_STREAM',
    'Speech_StreamPos_RealTime', 'DISPID_SRGDictationUnload',
    'ISpLexicon', 'SGRSTTTextBuffer', 'DISPID_SVStatus',
    'ISpeechMemoryStream', 'SRESoundEnd',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechMemoryStream',
    'SAFTGSM610_11kHzMono', 'IStream', 'SpNullPhoneConverter',
    ...
    'SAFTCCITT_uLaw_11kHzStereo', 'SpMMAudioIn', 'DISPID_SGRsAdd',
    'SPAUDIOSTATUS', 'DISPID_SpeechRecoResult', 'SRAONone',
    ...
    'SPSHT_Unknown', 'DISPID_SPPValue', 'SSFMCreate', 'SGDisplay',
    'SP_VISEME_15', 'DISPID_SDKEnumValues', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRRRecoContext', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SWFEBlockAlign', 'DISPID_SPIEngineId',
    'SpeechCategoryVoices', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIGetText', 'SpeechCategoryRecoProfiles',
    'DISPID_SVPause', 'SRTReSent', 'ISpeechVoiceStatus',
    'SAFTCCITT_uLaw_8kHzMono', 'SWTAdded', 'DISPID_SLPsItem',
    'SAFT22kHz8BitStereo', 'SPRS_INACTIVE', 'SPCT_SLEEP',
    'DISPID_SABufferInfo', 'DISPID_SRProfile', 'SAFT32kHz16BitMono',
    'SPTEXTSELECTIONINFO', 'DISPID_SDKEnumKeys', 'SPBOOKMARKOPTIONS',
    'SpeechSpecialTransitionType', 'SASRun', 'ISpRecognizer3',
    'DISPID_SRCVoice', 'DISPID_SpeechVoiceStatus',
    'SAFT48kHz16BitStereo', 'STCInprocHandler', 'ISpeechAudioFormat',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPDKL_LocalMachine', 'SVP_2', 'DISPID_SPPChildren',
    'SPCT_COMMAND', 'DISPID_SOTCSetId', 'DISPID_SPIStartTime',
    'ISpObjectToken', 'ISpPhoneConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVIsUISupported',
    'DISPID_SpeechVoice', 'DISPID_SRRAudio', 'SpPhraseInfoBuilder',
    '__MIDL_IWinTypes_0009', 'SpeechDictationTopicSpelling',
    'SPEI_SR_BOOKMARK', 'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE8',
    'SP_VISEME_17', 'SPLOADOPTIONS', 'DISPID_SPEsItem',
    'SPEI_RESERVED3', 'DISPIDSPTSI_SelectionLength',
    'DISPIDSPTSI_ActiveOffset', 'SpMemoryStream', 'SVPAlert',
    'SECFEmulateResult', 'SpSharedRecognizer',
    'DISPID_SRCRetainedAudioFormat', 'SpeechVoiceEvents',
    'SPEI_SOUND_END', 'ISpeechObjectTokenCategory',
    'SVEStartInputStream', 'SVEWordBoundary', 'SpeechRunState',
    'DISPID_SOTCategory', 'DISPID_SAFSetWaveFormatEx',
    'SPEI_RESERVED1', 'SpVoice', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseAlternate',
    'SPPS_RESERVED3', 'DISPID_SRRTLength', 'Speech_Default_Weight',
    'SPEI_TTS_PRIVATE', 'ISpeechTextSelectionInformation',
    'DISPID_SRCERecognition', 'SVEPhoneme',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SWFEFormatTag',
    'SpeechTokenShellFolder', 'SAFT48kHz8BitStereo',
    'ISpNotifySource', 'DISPID_SRCAudioInInterferenceStatus',
    'SAFTGSM610_22kHzMono', 'SPEI_END_INPUT_STREAM',
    'SPEI_RECOGNITION', 'DISPID_SPIReplacements', 'SPRST_ACTIVE',
    'eLEXTYPE_USER', 'SVEAudioLevel', 'DISPID_SpeechRecoResultTimes',
    'SPRECOSTATE', 'SRTSMLTimeout', 'SPSNotOverriden',
    'SPGS_EXCLUSIVE', 'SSSPTRelativeToEnd',
    'DISPID_SpeechPhraseReplacements', 'SREStreamEnd',
    'SVSFParseSsml', 'DISPID_SPEsCount', 'DISPID_SVGetVoices',
    'ISpeechRecoContext', 'DISPID_SDKDeleteValue',
    'ISpeechLexiconPronunciation', 'DISPID_SPRText',
    'SAFT8kHz8BitMono', 'DISPID_SPACommit', 'DISPID_SPAsCount',
    'DISPID_SGRSTransitions', 'ISpEventSource',
    'SPINTERFERENCE_TOOLOUD', 'ISpStreamFormat', 'SVSFIsFilename',
    'SpeechWordType', 'SpeechVisemeType',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT48kHz8BitMono', 'SDTProperty',
    'DISPID_SGRSTs_NewEnum', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_RESERVED4', 'SPAS_STOP', 'SINone',
    'DISPID_SRCEStartStream', 'ISpMMSysAudio',
    'DISPID_SpeechRecoContextEvents', 'SP_VISEME_10', 'SVSFVoiceMask',
    'DISPID_SpeechLexicon', 'SPPS_RESERVED1', 'SWTDeleted',
    'DISPID_SLPSymbolic', 'SGLexical', 'DISPID_SGRInitialState',
    'SGRSTTWord', 'SDA_No_Trailing_Space',
    'SpeechCategoryRecognizers', 'IInternetSecurityManager',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVWaitUntilDone',
    'ISpeechPhraseProperties', 'SPAO_NONE', 'SAFT24kHz8BitMono',
    'eWORDTYPE_ADDED', 'DISPID_SRCERecognizerStateChange',
    'SP_VISEME_13', 'DISPID_SPAPhraseInfo', 'SPEI_SR_AUDIO_LEVEL',
    'DISPIDSPRG', 'DISPID_SABufferNotifySize',
    'DISPID_SLAddPronunciation', 'DISPID_SRCRecognizer',
    'DISPID_SLPLangId', 'SVP_16', 'DISPID_SVDisplayUI',
    'SAFT44kHz16BitStereo', 'SPEI_MIN_TTS', 'DISPID_SGRClear',
    'tagSPTEXTSELECTIONINFO', 'ISpNotifySink', 'SAFT8kHz8BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTType',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_LETTERTOSOUND',
    'SVEBookmark', 'DISPID_SPRuleNumberOfElements', 'ISpeechDataKey',
    'SAFT11kHz8BitMono', 'DISPID_SWFEExtraData', 'DISPID_SVRate',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SASFreeBufferSpace',
    'ISpRecoGrammar2', 'SpeechCategoryPhoneConverters',
    'DISPID_SPAsItem', 'SPSInterjection', 'SpUnCompressedLexicon',
    'DISPID_SGRSTNextState', 'DISPID_SRGReset', 'DISPID_SAStatus',
    'SPSMF_SRGS_SAPIPROPERTIES', 'WAVEFORMATEX',
    'ISpeechCustomStream', 'DISPID_SRRSpeakAudio', 'SVEPrivate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVGetProfiles',
    'DISPID_SRRSetTextFeedback', 'SPAUDIOOPTIONS', 'SDTReplacement',
    'SpeechFormatType', 'DISPID_SOTDisplayUI',
    'DISPID_SPANumberOfElementsInResult', 'SRCS_Enabled',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRSCurrentStreamPosition',
    'SAFTNonStandardFormat', 'SVP_21', 'eLEXTYPE_PRIVATE11',
    'DISPID_SLPs_NewEnum', 'DISPID_SLWs_NewEnum',
    'DISPID_SRSClsidEngine', 'SGLexicalNoSpecialChars',
    'DISPID_SWFEBitsPerSample', 'SPPHRASE', 'SP_VISEME_2',
    'DISPID_SpeechGrammarRule', 'SRSEDone',
    'DISPID_SPRuleEngineConfidence', 'ISpeechGrammarRules',
    'DISPID_SpeechLexiconPronunciation',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechRecognizer',
    'DISPID_SPEEngineConfidence', 'SPPS_Noncontent',
    'ISpeechAudioBufferInfo', 'DISPID_SVSInputWordLength',
    'SPEI_RESERVED2', 'DISPID_SRGCommit', 'SREStateChange',
    'SpInProcRecoContext', 'IInternetSecurityMgrSite',
    'SpCompressedLexicon', 'DISPID_SPPName', 'DISPID_SPRuleName',
    'SVP_14', 'DISPID_SDKSetBinaryValue', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVVolume',
    'SAFTADPCM_11kHzStereo', 'SPFM_CREATE_ALWAYS', 'SPSNoun',
    'DISPID_SRCCreateGrammar', 'DISPID_SRGState', 'SGPronounciation',
    'SP_VISEME_16', 'DISPID_SLWWord', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechBaseStream', 'SpeechInterference', 'SPEI_PHONEME',
    'eLEXTYPE_RESERVED9', 'SECFIgnoreWidth',
    'DISPID_SpeechAudioBufferInfo', 'SSFMCreateForWrite',
    'SAFTGSM610_44kHzMono', 'DISPID_SRCEHypothesis',
    'DISPID_SRCEAdaptation', 'SRTEmulated',
    'DISPID_SPPNumberOfElements', 'DISPID_SLGetPronunciations',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechObjectToken', 'SpObjectToken', 'SPLO_DYNAMIC',
    'SPPARTOFSPEECH', 'SDKLDefaultLocation', 'ISpDataKey',
    'SFTSREngine', 'SPSSuppressWord', 'IEnumSpObjectTokens',
    'SP_VISEME_4', 'DISPID_SPRNumberOfElements',
    'SPEI_RECO_OTHER_CONTEXT', 'SVSFIsNotXML', 'SREAudioLevel',
    'eLEXTYPE_PRIVATE6', 'SpeechRecoProfileProperties',
    'SDKLCurrentConfig', 'DISPID_SRCERequestUI', 'SVSFNLPSpeakPunc',
    'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE14', 'tagSPPROPERTYINFO',
    'SPWORDTYPE', 'DISPID_SPRuleParent', 'SPEI_START_INPUT_STREAM',
    'SPDKL_CurrentUser', 'SPVOICESTATUS', 'SPSFunction'
]

_check_version('1.2.1', 1700111613.790381)
